...
export default function TheologyAssistant() {
  ...
  // AI query rate limiting (5 per day, client-side, keyed on browser localStorage —
      ...
      <div className="header-wrap" style={{ display: "flex", alignItems: "center", gap: 16, padding: "12px 24px", background: dark, flexShrink: 0 }}>
        ...
        <div className="header-tabs" style={{ display: "flex", gap: 5, flexWrap: "wrap", justifyContent: "flex-end", alignItems: "center" }}>
          ...
          <div style={{ display: "flex", gap: 2, marginLeft: 4 }}>
            ...
            <button onClick={() => { setLang("de"); try { const p = window.location.pathname; if (!p.startsWith("/de/") && p !== "/de") history.replaceState(null, "", p === "/" ? "/de" : "/de" + p); } catch {} }} style={{ padding: "2px 6px", background: lang === "de" ? gold : "transparent", color: lang === "de" ? dark : "#a09070", border: "1px solid " + (lang === "de" ? gold : "#a09070"), borderRadius: "0 6px 6px 0", fontSize: 10, cursor: "pointer", fontFamily: "Georgia, serif", fontWeight: lang === "de" ? "bold" : "normal" }}>DE</button>
          </div>
